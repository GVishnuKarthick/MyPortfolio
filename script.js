...
function openDemo(projectName) {
    const demoUrls = {
        'TrafficEscape': 'https://drive.google.com/drive/folders/1SF2wIV2usjJL8msZJiA2hNH-XXIIyF0T',
...
function openGitHub(projectName) {
    const githubUrls = {
        'TrafficEscape': 'https://github.com/GVishnuKarthick/trafficescape',
        'CrazyNinjaFrog': 'https://github.com/GVishnuKarthick/crazy-ninja-frog',
        'FightMania': 'https://github.com/GVishnuKarthick/fight-mania',
